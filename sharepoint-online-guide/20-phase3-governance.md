...
> フェーズ3の施策は、**E3 標準でできること**、**Entra ID P1／P2 が要ること**、**SharePoint Advanced Management（SAM。有償アドオン。価格は要見積もり／代理店確認）が要ること**が混在します。まず E3・E3内包の P1 でできる統制から着手し、自動化（SAM・P2）は規模とリスクに応じて投資判断します。ライセンス条件は改定されるため、契約前に一次情報でご確認ください。
...
| **制限付きアクセス制御／制限付きコンテンツ検出（RCD）** | **SAM（有償アドオン）** 〔S37〕 |
