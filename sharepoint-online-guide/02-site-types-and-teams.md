...
| --- | --- | --- | --- | --- |
| **チームサイト（グループ連携）** | あり | チーム・部門の共同作業。Teams/Planner 等と連動 〔S6〕 | メンバー全員が編集可 〔S1〕 | ◎（共同作業の標準） |
...
> 現場の共同作業は「まず Teams チームを作る」で概ね正解です。ただし、**誰でも無制限に作れる状態はサイト乱立**を招きます。フェーズ1では「作成は情シス経由 or 申請制」といった**軽いブレーキ**を掛け、本格的な作成申請ワークフロー・棚卸はフェーズ3で運用化します。
